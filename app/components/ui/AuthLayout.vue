...
<template>
  <div>
    <div class="grid grid-cols-[2fr_1fr] max-md:grid-cols-1">
      <div class="mx-33.75 my-10 max-lg:mx-20 max-sm:mx-10 max-md:my-6">
        <img
          src="/images/logo.png"
          alt="Logo"
          loading="lazy"
          ...
          @click="navigateTo('/')"
        />
        <p class="text-xl font-bold mb-6 max-md:mb-4">{{ subTitle }}</p>
      ...
      <img
        ...
        alt="Banner"
        loading="lazy"
        class="object-cover h-full w-full max-md:hidden"
        :class="heightImg"
      />
    </div>
  </div>
